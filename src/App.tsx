...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-stone-900 antialiased selection:bg-rose-100 selection:text-[#be185d]">
      ...
      {/* HEADER */}
      <header className={`fixed top-0 sm:top-18 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-white shadow-lg py-2 border-b border-rose-50' : 'bg-transparent py-4'}`}>
